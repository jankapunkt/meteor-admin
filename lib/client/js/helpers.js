...
Template.registerHelper('adminEq', (a, b) => a === b)

Template.registerHelper('AdminCache', () => AdminCache)

Template.registerHelper('admin_skin', () => (AdminConfig.get().skin) || 'blue')

Template.registerHelper('admin_collections', adminCollections)

Template.registerHelper('admin_collection_name', () => AdminCache.get('admin_collection_name'))

Template.registerHelper('admin_current_id', () => AdminCache.get('admin_id'))

Template.registerHelper('admin_current_doc', () => AdminCache.get('admin_doc'))

Template.registerHelper('admin_is_users_collection', () => AdminCache.get('admin_collection_name') === 'Users')
...
Template.registerHelper('admin_omit_fields', function () {
  ...
  if (!AdminCache.equals('admin_collection_name', 'Users') && (typeof AdminConfig !== 'undefined') && (typeof AdminConfig.collections[ AdminCache.get('admin_collection_name') ].omitFields === 'object')) {
    collection = AdminConfig.collections[ AdminCache.get('admin_collection_name') ].omitFields
  }
